...
Similarly, the supplied Ether value can be controlled too::
    ...
    nameReg.call.value(1 eth)("register", "MyName");

Lastly, these modifiers can be combined. Their order does not matter::

    nameReg.call.gas(1000000).value(1 eth)("register", "MyName");
...
.. note::
    It is possible to use an array of bytes as ``byte[]``, but it is wasting a lot of space, 31 bytes every every element,
