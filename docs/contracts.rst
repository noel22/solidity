...
.. warning::
    A contract without a payable fallback function can receive Ether as a recipient of a `coinbase transaction` or
    as a destination of a ``selfdestruct``. This is a design choice of the EVM and Solidity cannot work it around.
